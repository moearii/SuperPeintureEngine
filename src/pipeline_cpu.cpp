...
void Pipeline_CPU::run_8_samples(Pigment * pig1, Pigment * pig2, float concentration, Light * lum, glm::vec3 & couleur){
    // need Hi et lamdi
}

void Pipeline_CPU::run_full_samples(Pigment * pig1, Pigment * pig2, float concentration, Light * lum, glm::vec3 & couleur){
